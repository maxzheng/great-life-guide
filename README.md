...
3. **Unity**: While a single person can do amazing things, but the greatest things can only be accomplished when we work
   together as one. That is every single living being, not just humans, as we interdepend. More than half of your body
   cells are microbes! Divisions of countries, races, companies, individual families are superficial, archaic, and only
   causes harm. It's ok to have groups, but not superficial barriers that reduce collaboration, nor thinking other
